    ...
    <section id="cabecera">
        <div class="contenedor">
            <div id="Mensaje">
                ...
                <p style=" font-family: 'Yatra One'">Como vemos en esta sección encontramos la lista de roles
                    que hasta el momento hemos insertado junto con el nombre del rol.
                </p>
            </div>
        </div>
    </section>
        ...
        <div id="tablas">
            <div class="contenedor">
                <form method="POST" action="select.php" method="post" enctype="multipart/form-data">
                    <h1 class="animate__animated animate__backInLeft" style="color:  #360617; font-size:50px; font-family: 'Yatra One', cursive;text-align:center">Listado de Roles</h1>
                    <center>
                        <table style="font-family: 'Yatra One';font-size:30px">
                            ...
                            ?>
                                <td><?php
                                    $sub_sql_1 = "SELECT NombreRol FROM rol WHERE idrol=" . $id_rol;
                                ...
                                <td>
                                    <a style="color:#E63946" href="update.php?actualizar=<?php echo $id_rol; ?>"> Actualizar
                                    </a>
                                </td>
                                <td>
                                    <a style="color:#E63946" href="select.php?eliminar=<?php echo $id_rol; ?>"> Eliminar
                                    </a>
                                </td>
                                </tr>
                            <?php
                    ...
                    if (isset($_GET['eliminar'])) {
                        ...
                        if ($Rol != 1) {
                            ...
                            $eliminar = "DELETE FROM rol WHERE idrol='$borrar_id'";
                            $ejecutar = mysqli_query($conexion, $eliminar);

                            if ($ejecutar) {
                                echo "<script>alert('El rol ha sido eliminado!')</script>";
                                echo "<script>window.open('select.php','_self')</script>";
                            }
                        }
                    }
