...
<head>
    ...
    <title>Insertar Estado Cuota</title>
</head>
...
<body>
    ...
    <section id="cabecera">
        <div class="contenedor">
            <div id="Mensaje">
                <h1 style=" font-family: 'Yatra One'">Insertar Estado Cuota</h1>
                <p style=" font-family: 'Yatra One'">Si desea agregar un nuevo estado cuota abajo está la opción
    ...
    <section id="Boletin">
        <div class="contenedor">
            ...
            <form class="form-register" action="insert.php" method="POST" enctype="multipart/form-data">
                ...
                <h3 style="text-align: justify;">Nombre Estado Cuota</h3>
                <input class="controls" type="text" style="font-size: 150%; color:black;" name="txtNombrestado" placeholder="Nombre">
                <br>
                <?php
                if (isset($_POST['Enviar'])) {
                    $sql = 'insert into estado_cuota(Nombrecuota) values ("' . $_POST['txtNombrestado'] . '")';
